...
ADD THIS TO MISSION OBJECTS YOU WISH TO BE ROB-ABLE
...
titleText[format["You have stolen $%1, you should probably run before the cops arrive!",[_kassa] call life_fnc_numberText],"PLAIN"];
