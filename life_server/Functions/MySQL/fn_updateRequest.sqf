...
switch (_side) do {
	...
	case independent: {_query = format["UPDATE players SET name='%1', cash='%2', bankacc='%3', med_licenses='%4', med_gear='%5' WHERE playerid='%6'",_name,_cash,_bank,_licenses,_gear,_uid];};
};
